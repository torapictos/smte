...
<?php } ?>
<?php if ($page == 'sc-projects-list.php' || $page == 'form-select2.php'|| $page == 'ui-clipboard.php') {   ?>
	<!-- Select2 CSS -->
...
<?php }
if (
	$page == 'projects-add.php' || $page == 'profile.php' ||$page == 'sc-students-list.php' ||$page == 'sc-teacher-list.php' || $page == 'sc-boss-list.php' || $page == 'sc-retire-list.php' 
) { ?>
	<!-- Select2 CSS -->
...
if (
	$page == 'sc-projects-list.php' || $page == 'associate-dashboard.php'|| $page == 'sc-students-list.php' || $page == 'sc-teacher-list.php' || $page == 'sc-boss-list.php' || $page == 'sc-retire-list.php'
) { ?>
	<!-- Datatable CSS -->
